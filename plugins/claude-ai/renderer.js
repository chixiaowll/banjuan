const CLAUDE_LOGO_SVG = `<svg viewBox="0 0 24 24" fill="#c96442"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3.5l5.5 9.5h-11L12 5.5z"/></svg>`
const CLAUDE_STAR_SVG = `<svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M12 2l2.4 7.2H22l-6 4.8 2.4 7.2L12 16.4l-6.4 4.8L8 14l-6-4.8h7.6L12 2z" fill="#c96442"/></svg>`
