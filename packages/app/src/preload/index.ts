...
const api = {
  ...
  documents: {
    import: (destDir?: string) => ipcRenderer.invoke('documents:import', destDir),
    ...
    markRead: (id: string) => ipcRenderer.invoke('documents:markRead', id),
    refresh: () => ipcRenderer.invoke('documents:refresh'),
